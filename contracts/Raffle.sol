...
//Enter the lottery (paying some money)
...
/* @title A sample Raffle/Lottery automated contract
   @author Selaru Daniel / @daniy310
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    * @dev This is the function that the Chainlink Keeper nodes call
        ...
        The following should be true to return true : 
            ...
            - our subcription is funded with LINK
   ...
   function checkUpkeep(bytes memory /*checkData*/) public override returns(bool upkeepNeeded, bytes memory /*performData */) {
    ...
    //because the function need 2 parameters but we are only using one we can comment the first one so we don't get any warnings
